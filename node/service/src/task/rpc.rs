...
use dkg_rpc::{SyncKeyGenerator, SyncEncKey, SyncFinalizedEncKeys, SyncDecKey, GetKeyGeneratorList, GetEncKey, GetDecKey, GetSessionId};

/// Configure the cluster RPC server.
pub async fn default_cluster_rpc_server<C: Config>(ctx: &C) -> Result<RpcServer<C>, C::Error> {
